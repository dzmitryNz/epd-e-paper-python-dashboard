...
- **Крыніцы даных**: OpenWeatherMap, платы WiFi-IoT (тэкставы пратакол `ключ:значэнне;`), тыкеры KuCoin, статыстыка пула Solopool, JSONP-дашборд майнера Nano3
...
Радок з `"type": "verbs"` займае рэшту экрана табліцай дзеясловаў з пагінацыяй (палі: `font`, `lineHeight`, `colour`, `secondaryColour`). Старонка пераключаецца кожныя 5 хвілін; прагрэс захоўваецца ў `verbs_state.json`.
