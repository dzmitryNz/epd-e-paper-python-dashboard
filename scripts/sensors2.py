...
show_sensor_names = ['dsw1', 'dsw2']
sensor_names = { 'dsw1': 'Outside', 'dsw2': 'Balcony' }
sensor_units = { 'dsw1': '°C', 'dsw2': '°C' }
if len(sys.argv) > 1:
    url = sys.argv[1]
        ...
        for pair in pairs:
            if ':' in pair:
                ...
                if key in sensor_names and key in sensor_units:
                    sensor_data[key] = { 'value': value, 'name': sensor_names[key], 'unit': sensor_units[key] }
